...
public class fin_tarama_sayfasi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fin_tarama_sayfasi);
        if (intent != null) {
            String ip = intent.getStringExtra("ip");
            String port = intent.getStringExtra("port");
        }
        // Python betiği
        String pythonScript = "C:\\Users\\metis\\MPTS-master\\MPTS-master\\app\\src\\main\\scripts\\FIN_scan.py";
        ...
        TextView os_sonuc = findViewById(R.id.ip_sonuc);
