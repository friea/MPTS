...
public class connect_tarama_sayfasi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_connect_tarama_sayfasi);
        if (intent != null) {
            String ip = intent.getStringExtra("ip");
            String port = intent.getStringExtra("port");
        }
        // Python betiği
        String pythonScript = "C:\\Users\\metis\\MPTS-master\\MPTS-master\\app\\src\\main\\scripts\\TCP_scan.py";
        ...
        TextView os_sonuc = findViewById(R.id.connect_sonuc);
